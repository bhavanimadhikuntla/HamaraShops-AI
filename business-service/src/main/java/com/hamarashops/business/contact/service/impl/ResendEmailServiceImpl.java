package com.hamarashops.business.contact.service.impl;
...
import com.hamarashops.business.contact.service.ResendEmailService;
...
public class ResendEmailServiceImpl implements ResendEmailService {
    ...
    public String sendInquiryEmail(ContactInquiryRequest request) {
        ...
        if (!apiKeyPresent) {
            ...
            throw new IllegalStateException("RESEND_API_KEY environment variable is not configured on the backend server. Please configure RESEND_API_KEY in the business-service.");
        }
